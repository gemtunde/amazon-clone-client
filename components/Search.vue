<template>
    ...
    <form  onsubmit="return false;" class="searchbox sbx-amazon">
      <div role="search" class="sbx-amazon__wrapper">
        <input type="search" name="search" placeholder="Search your favourite product" autocomplete="off"  class="sbx-amazon__input">
