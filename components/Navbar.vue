        ...
        <header class="nav-opt-sprite nav-locate-us nav-lang-en nav-ssl nav-unrec">
            <div class="container-fluid desktop-nav">
                ...
                <div class="row">
                            ...
                            <div class="nav-shop">
                                <nuxt-link to="/history" class="nav-a nav-a-2 nav-single-row-link">
                                    <span class="nav-line-2">
                                        Browsing Histroy
                                        <span class="nav-icon nav-arrow" style="visibility:vi"></span>
                                    </span>                                    
                                </nuxt-link>
                            </div>
                    ...
                    <!-- Accounts and orders -->
                     <div class="col-xl-4 col-lg-5 col-md-4 col-sm-4 p-0">
                        <div class="nav-tools">
                            ...
                            <nuxt-link class="nav-a nav-a-2" to="/cart" id="nav-cart">
